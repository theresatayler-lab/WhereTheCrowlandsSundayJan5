...
export const ARCHETYPES = [
  ...
  },
  {
    ...
    shortName: 'Catherine',
    era: 'Victorian/Edwardian Spitalfields',
    birdSymbol: 'Finches & Magpies',
    birdEmoji: '🐦',
    colorScheme: {
      primary: '#4B5A3E',
      secondary: '#D8CBB3',
    ...
    bio: `Catherine, the "bird-witch," embodied the creative fusion of Huguenot and Irish traditions. A Spitalfields artisan, musician, and mother, she blended music, folklore, and protective magic, passing down rituals that honored both craft and spirit. Her marriage was a strategic alliance, but her heart belonged to the making of things: songs, spells, and stories that wove the family together. Catherine's legacy is one of joyful creativity and cross-cultural wisdom.`,
    empowermentMessage: `"Creation is its own spell. In music, in craft, in the flight of birds—magic finds its form. Blend what you have, honor your roots, and let your hands and heart shape the ritual."`,
    ritualStyle: 'Music, craft, bird magic, folklore. Rituals for creativity, blending traditions, protection, and honoring artisanship. Bird-witch magic using feathers, songs, and nature motifs.',
    specialties: [
      'Creativity & Inspiration',
      'Craft & Artisan Magic',
      'Bird Magic & Nature Connection',
      'Blending Spiritual Traditions',
      'Working-Class Wisdom'
    ],
    bestFor: [
      'Need creative inspiration',
      'Honoring artisan or working-class roots',
      'Blending different spiritual traditions',
      'Connecting with birds and nature spirits',
      'Using music or craft in your practice'
    ],
    samplePrompts: [
      'How can I bring more creativity into my rituals?',
      'Create a bird-based protection charm',
      'Help me blend Huguenot and Irish magical practices',
      'What\'s a ritual for honoring ancestors through music?'
    ],
    tenets: [
      ...
      'Honor the craft of your ancestors',
      'Blend what works; discard what doesn\'t',
      'Nature provides all the tools you need',
      'Joy is the highest form of magic'
    ],
    historicalSources: [
      'Spitalfields artisan traditions',
      'Huguenot folk practices',
